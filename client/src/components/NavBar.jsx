...
function NavBar({ setActionState, documentId, access }) {
        ...
        <div className="flex flex-row gap-4">
          ...
          <div className="flex flex-col items-start justify-center">
            <div className="flex flex-row items-center gap-5">
              ...
              <p className={`rounded px-3 py-1 ${access===""?"":access==="OWNER"?'bg-red-200 text-red-600': access==="READ"?'bg-blue-200 text-blue-600 px-3':'bg-green-200 text-green-600 '}`}>{access}</p>
            </div>

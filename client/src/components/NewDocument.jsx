      ...
      <div className="bg-white overflow-auto flex flex-col items-center p-5 border rounded-lg border-gray-300 w-[50%] py-10">
        ...
        <div className=" flex flex-col items-center w-full mt-5 gap-5">
          <div className="flex flex-row gap-5 w-[100%] justify-center items-center">
            ...
            <input type="text" value={currId} onChange={(e)=>setCurrId(e.target.value)} className="color-black w-[50%] border border-gray-400 rounded-lg h-10 px-2" />
          </div>
            <button className="bg-[#192952] text-white px-5 py-2 border rounded-lg cursor-pointer" onClick={handleSubmit}>Create</button>
        </div>
      </div>
    </div>
  );

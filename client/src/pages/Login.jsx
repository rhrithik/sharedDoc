  ...
  return (
    ...
    >
      <div className="flex flex-col bg-white gap-5 border border-gray-200 h-[70%] w-[50%] items-center justify-center rounded-xl px-5">
        ...
        <form className="flex flex-col gap-5 w-[100%] lg:w-[50%]" onSubmit={handleLogin}>
          <div>
          ...
          <button type='submit' className="bg-blue-500 text-white px-3 py-1 rounded-sm cursor-pointer text-center">
            Login
          </button>
        </form>
        <button
